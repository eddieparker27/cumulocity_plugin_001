...
@font-face {
  ...
  src: url("@{path}/c8yicon-dark.eot");
  src: url("@{path}/c8yicon-dark.eot?#iefix") format("embedded-opentype"),
       url("@{path}/c8yicon-dark.woff") format("woff"),
       url("@{path}/c8yicon-dark.ttf") format("truetype"),
       url("@{path}/c8yicon-dark.svg#c8yicon-dark") format("svg");
  font-weight: normal;
  font-style: normal;
}
...
@media screen and (-webkit-min-device-pixel-ratio:0) {
  ...
  @font-face {
    font-family: "c8yicon-dark";
    src: url("@{path}/c8yicon-dark.svg#c8yicon-dark") format("svg");
  }
}
...
@font-face {
  ...
  src: url("@{path}/c8yicon-light.eot");
  src: url("@{path}/c8yicon-light.eot?#iefix") format("embedded-opentype"),
       url("@{path}/c8yicon-light.woff") format("woff"),
       url("@{path}/c8yicon-light.ttf") format("truetype"),
       url("@{path}/c8yicon-light.svg#c8yicon-light") format("svg");
  font-weight: normal;
  font-style: normal;
}
...
@media screen and (-webkit-min-device-pixel-ratio:0) {
  ...
  @font-face {
    font-family: "c8yicon-light";
    src: url("@{path}/c8yicon-light.svg#c8yicon-light") format("svg");
  }
}
