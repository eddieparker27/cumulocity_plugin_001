  ...
  >li {
    ...
    >a {
      ...
      &:hover {
        ...
        text-decoration-color: @input-focus-color;
      }
    ...
    &.active>a {
      ...
      &:hover,
      &:focus {
        border-top-color: @nav-tabs-active-link-hover-bg;
        border-bottom-color: @brand-primary;
        background-color: transparent;
...
.nav-tabs-vertical {
  ...
  >li {
    ...
    >a {
      ...
      margin:0;
      border: 0;
      background-color: @nav-tabs-vertical-bgcolor;
      color: @nav-tabs-vertical-color;
      text-transform: none;
      font-size: inherit;
      display:flex;
      align-items: center;
      box-shadow: inset 0 -1px 0 @nav-tabs-border-color;
    ...
    &.active {
      >a,
      a:hover {
        border-left: 4px solid @nav-tabs-vertical-active-bg;
        color: @nav-tabs-vertical-active-bg;
        background-color: transparent;
        &::before {
          width: 100%;
        }
